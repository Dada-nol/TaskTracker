  ...
  return (
    <div className="space-y-1">
      <div className="flex justify-between items-center">
        <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">XP</span>
        <span className="text-xs font-mono text-gray-400">{currentXP} / {xpToNextLevel}</span>
      </div>
      <div className={`w-full bg-gray-100 border border-gray-200 ${size === "md" ? "h-2" : "h-1.5"}`}>
